...
// 0x1c : reserved
// 0x20 : Data signal of count
//        bit 31~0 - count[31:0] (Read)
// 0x24 : Control signal of count
//        bit 0  - count_ap_vld (Read/COR)
//        others - reserved
// 0x30 : Data signal of success
//        bit 31~0 - success[31:0] (Read)
// 0x34 : Control signal of success
...
#define XAD_FIFO_ALL_CONTROL_ADDR_COUNT_DATA     0x20
#define XAD_FIFO_ALL_CONTROL_BITS_COUNT_DATA     32
#define XAD_FIFO_ALL_CONTROL_ADDR_COUNT_CTRL     0x24
#define XAD_FIFO_ALL_CONTROL_ADDR_SUCCESS_DATA   0x30
#define XAD_FIFO_ALL_CONTROL_BITS_SUCCESS_DATA   32
#define XAD_FIFO_ALL_CONTROL_ADDR_SUCCESS_CTRL   0x34
